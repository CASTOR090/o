...
const Mensagens = () => {
    ...
    useEffect(() => {
        // Sempre inicia uma nova conversa
        setMensagens([]);
    ...
    const salvarConversa = (novasMensagens) => {
        ...
        // Salva também no histórico de conversas
        const conversasAnteriores = JSON.parse(localStorage.getItem('conversasAnteriores') || '[]');
        const conversaAtual = {
            id: Date.now(),
            data: new Date().toLocaleString(),
        ...
        // Remove conversa anterior se existir e adiciona a atual
    ...
    const iniciarChat = () => {
        // Salva conversa anterior se existir
    ...
    const enviarRespostaBot = (texto, isBot) => {
        const resposta = {
            id: Date.now(),
            texto,
            isBot,
        ...
        const novasMensagens = [...mensagens, resposta];
        setMensagens(novasMensagens);
        salvarConversa(novasMensagens);
    };
